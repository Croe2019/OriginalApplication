...
class MenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        // ホーム、ゴミ箱はデフォルトで表示する
        // メニューの機能実装時には変更する
        menuList = ["新規作成", "ホーム", "画像を解析", "物体を検出", "アラームを設定"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            self.dismiss(animated: true, completion: nil)
        case 2: performSegue(withIdentifier: "Scan", sender: nil)
        case 3: performSegue(withIdentifier: "ObjectScan", sender: nil)
        case 4: performSegue(withIdentifier: "Notification", sender: nil)
